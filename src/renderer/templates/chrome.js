  ...
  var METRIC_TIPS = {
    ...
    'Circular dependencies':  'Production-source files that mutually depend on each other: A\u2192B and B\u2192A (depth 1), or A\u2192B\u2192C\u2192A (depth 2). Self-imports are ignored. At 100+ source files the stricter of affected-file prevalence and the absolute count bands applies; below 100 the count bands apply.',
    ...
    'Test safety net': 'Source files whose compatible same-project, same-language naming-convention-paired test has stopped co-changing with them. At 100+ source files the stricter of eroding-pair prevalence and the absolute count bands applies; below 100 the count bands apply.'
  };
