  ...
  var METRIC_TIPS = {
    ...
    'Circular dependencies':  'Production-source files that mutually depend on each other: A\u2192B and B\u2192A (depth 1), or A\u2192B\u2192C\u2192A (depth 2). Self-imports are ignored. Repositories with 300+ production-source files are scored by the prevalence of affected files; between 100 and 300 the stricter of prevalence and the absolute count bands applies, and below 100 the count bands alone.',
    ...
    'Test safety net': 'Source files whose compatible same-project, same-language naming-convention-paired test has stopped co-changing with them. Repositories with 300+ production-source files are scored by the prevalence of eroding checked pairs; between 100 and 300 the stricter of prevalence and the absolute count bands applies, and below 100 the count bands alone.'
  };
